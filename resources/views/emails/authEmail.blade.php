...
<script src="https://cdn.jsdelivr.net/npm/vuedarkmode@latest/dist/vuedarkmode.min.js"></script>
    <style type="text/css">
      ...
      .report-table td{padding: 5px 10px;}
      .report-table tr:nth-child(even) td {background: #CCC}
                            ...
                            <table width="600" cellpadding="0" cellspacing="0" border="0" class="container" align="center">
                              ...
                              <tr>
                                <td align="center" class="hund" width="600">
                                  <img src="https://storage.googleapis.com/val-log/logo.png" width="200" alt="Logo" border="0" style="max-width: 300px; display:block; ">
                                </td>
                              </tr>
                              <!-- END HEADER IMAGE -->
                            </table>
                  ...
                  <tr>
                    <td style="border-radius: 3px; border-bottom: 2px solid #d4d4d4;" class="card-1" width="100%" valign="top" align="center">
                      <table style="border-radius: 3px;" width="600" cellpadding="0" cellspacing="0" border="0" align="center" class="wrapper" bgcolor="#ffffff">
                        <tr>
                          <td align="center">
                            <table width="600" cellpadding="20" cellspacing="0" border="0" class="container">

<h1>Welcome to the Virtual Atheletics League</h1><p>
Someone has registed this email address to https://www.valvr.com, If this was your self please click
here:<br><br> <a href ="https://www.valvr.com/activation?token={{$activationToken}}">Activate</a>
  or copy and paste this link in to your browser<br>
<br>
  https://www.valvr.com/activation?token={{$activationToken}}
<br>
<br>
  If this was not you, please disregard and in 30 days this link and access will be terminated.
</p>
</p>
                            </table>
                          </td>
                  ...
                  <tr>
                    <td align="center">
                     ...
                     <!--      <td align="center" bgcolor="#eeeeee">
                            <a href="#" target="_blank" style="font-size: 12px; line-height: 14px; font-weight: 500; font-family: 'Roboto Mono', monospace; color: #212121; text-decoration: underline;padding: 0px; border: 1px solid #eeeeee; display: inline-block;">Unsubscribe</a>
                          </td> -->
                        </tr>
                      </table>
                    </td>
